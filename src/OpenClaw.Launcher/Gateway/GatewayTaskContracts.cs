...
/// </summary>
public enum GatewayTaskPresence
{
...
public sealed record GatewayTaskProbe(
...
public sealed record GatewayTaskOperation(bool Succeeded, string? Detail)
{
...
/// </remarks>
public interface IGatewayTaskScheduler
{

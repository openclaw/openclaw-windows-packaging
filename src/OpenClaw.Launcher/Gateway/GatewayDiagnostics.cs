...
public sealed record GatewayDiagnostic(string Name, bool? Ok, string Detail);
...
/// </remarks>
public sealed record GatewayDiagnosticReport(
...
internal static class GatewayDiagnostics
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        [
            ...
            await CheckNodeAsync(resolveNode, cancellationToken),

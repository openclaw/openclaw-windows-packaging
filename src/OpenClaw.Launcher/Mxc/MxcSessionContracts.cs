...
/// </summary>
public readonly record struct MxcSandboxId
{
...
/// </summary>
public sealed record MxcProvisionMetadata(
...
/// </summary>
public sealed record MxcProvisionRequest(string AppId);

public sealed record MxcProvisionResult(
...
/// </remarks>
public sealed record MxcExecutionRequest(string CommandLine);

public sealed record MxcExecutionResult(
    int ExitCode,
...
/// </summary>
public interface IMxcSessionClient
{

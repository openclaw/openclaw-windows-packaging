...
/// </summary>
public sealed class SessionStateException : SessionException
{
...
/// </summary>
public sealed class SessionBusyException : SessionException
{
...
/// </param>
public sealed record SessionRemovalResult(bool Removed, string? StopFailure);

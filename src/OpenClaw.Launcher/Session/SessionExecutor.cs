...
/// </summary>
public sealed record SessionExecutionRequest(
    string HelperPath,
    string NodePath,
...
/// flattening.
/// </remarks>
public sealed class SessionExecutor
{
    ...
    private static IReadOnlyList<string> BuildNodeArguments(
        SessionExecutionRequest request)
    {
    ...
    /// </remarks>
    private int ReadOutcome(string resultPath, int executorExitCode, string requestId)
    {
        string resultText;
        try
        {

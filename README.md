...
the resolved commit, Node.js version, and payload-build script. A tarball cache
hit still verifies the recorded commit and SHA-256; a dependency-tree hit still
runs every payload validation and smoke test. Official-signing workflows bypass
